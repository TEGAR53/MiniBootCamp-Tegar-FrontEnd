        ...
        <section className="py-20 px-4 md:px-6 flex flex-col items-center text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              notedev helps you capture ideas, organize tasks, and stay in sync
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="border rounded-md p-4 hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    Buat aplikasi web dengan React dan Tailwind CSS.
                    Implementasikan fitur CRUD untuk manajemen data.
                  </p>
                  <p className="text-xs text-muted-foreground">
                    Created: Jul 14, 2023, 01:20:54 PM
                  </p>
                </div>
                ...
                <div className="border rounded-md p-4 hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    Siapkan materi untuk quiz minggu depan. Fokus pada HTML,
                    CSS, dan JavaScript dasar.
                  </p>
                  <p className="text-xs text-muted-foreground">
                    Created: Jul 14, 2023, 01:20:56 PM
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-background p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-muted-foreground">
                  Create beautiful notes with formatting, images, checklists,
                  and more.
                </p>
              </div>
              ...
              <div className="bg-background p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-muted-foreground">
                  Keep your notes organized with notebooks, tags, and powerful
                  search.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-background p-6 rounded-lg border">
                ...
                <p className="mb-4 italic">
                  "notedev has completely transformed how I organize my work and
                  personal projects. Can't imagine life without it now."
                </p>
              ...
              <div className="bg-background p-6 rounded-lg border">
                ...
                <p className="mb-4 italic">
                  "The seamless sync across devices and clean interface make
                  notedev the best note-taking app I've ever used."
                </p>
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-muted"></div>
                  <div>
              ...
              <div className="bg-background p-6 rounded-lg border">
                ...
                <p className="mb-4 italic">
                  "As a student, I rely on notedev for all my classes. The
                  organization features help me keep everything in perfect
                  order."
                </p>
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-muted"></div>
        ...
        <section className="py-20 bg-muted/50 flex flex-col items-center">
          <div className="container text-center">
            ...
            <p className="text-xl mb-10 max-w-2xl mx-auto opacity-90">
              Join thousands of users who organize their work and life with
              notedev.
            </p>
            <Link to="/register">
